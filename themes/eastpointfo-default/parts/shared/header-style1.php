	...
	<div class="top-line">
		<div class="container">
			<div class="row">
				...
				<div class="header-topline-menu col-lg-3 navbar-expand-lg navbar-dark d-none d-lg-block">
					<?php wp_nav_menu(
						array(
				...
				<div class="col-lg-6 col-sm-6 col-xs-6 col-5 text-right">
					<?php
			...
			<div class="container">
				...
				<?php endif; ?>
						...
						<div class="utility-nav navbar-right">
					        ...
					        $email_address = get_field('global_email', 'option');
					        if ($email_address): ?>
					            <span class="sh-email d-md-none m-0"><a class="cms_email" href="mailto:<?php echo strtolower($email_address); ?>" title="Email Us"><span class="material-icons">mail_outline</span> <span><?php echo $email_address; ?></span></a></span>
					        <?php endif ?>
							...
							if( $link ): 
							    ...
							    <a class="button btn btn-secondary d-lg-none px-4 m-0" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>"><?php echo esc_html( $link_title ); ?></a>
							<?php endif; ?>
						</div>
